...
df_data = pd.read_csv('C:/Users/guibi/PycharmProjects/QDC_group7/QDC_git/DATASET_prepared_GENX.csv', index_col=0, header=0,
                      low_memory=False)
...
graph.write_png('QDC_ML_BIOLLAZ_5APP3MT_GENX.png')
